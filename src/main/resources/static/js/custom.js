			...
			$("#jplayer_1").jPlayer({
				ready: function () {
					$(this).jPlayer("setMedia", {
						title:"Better Days",
							artist:"Bensound",
							mp3:"static/files/bensound-betterdays.mp3"
					});
				},
			...
			[
				{
					...
					album:"Ocean Vibes",
					mp3:"static/files/bensound-betterdays.mp3",
					poster:"static/images/featured_1.jpg"
				},
				{
					title:"Dubstep",
					artist:"Bensound",
					album:"DJ Mind",
					mp3:"static/files/bensound-dubstep.mp3",
					poster:"static/images/featured_2.jpg"
				},
				{
					title:"Sunny",
					artist:"Bensound",
					album:"Dublin Dub",
					mp3:"fstatic/iles/bensound-sunny.mp3",
					poster:"static/images/featured_3.jpg"
				},
				{
					title:"Better Days",
					artist:"Bensound",
					album:"Ocean Vibes",
					mp3:"static/files/bensound-betterdays.mp3",
					poster:"static/images/featured_4.jpg"
				},
				{
					title:"Dubstep",
					artist:"Bensound",
					album:"DJ Mind",
					mp3:"static/files/bensound-dubstep.mp3",
					poster:"static/images/featured_5.jpg"
				},
				{
					title:"Sunny",
					artist:"Bensound",
					album:"Dublin Dub",
					mp3:"static/files/bensound-sunny.mp3",
					poster:"static/images/featured_6.jpg"
				}
			];
